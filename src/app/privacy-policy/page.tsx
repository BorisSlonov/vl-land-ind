          ...
          <div className={styles.content}>
            <section className={styles.section}>
              ...
              <p className={styles.bold}>
                ...
                предпринимаемые ООО УЦПК &quot;ВИБРО-ЛАЗЕР&quot; ОГРН:
                1247800046482, ИНН: 7810969798 (далее — Оператор).
              </p>
              <ul className={styles.list}>
                ...
                <li>
                  ...
                  веб-сайта https://vibrolaser-edu.pro/.
                </li>
              </ul>
            </section>
            <section className={styles.section}>
              ...
              <ul className={styles.list}>
                ...
                <li>
                  ...
                  адресу https://vibrolaser-edu.pro/.
                </li>
                <li>
                ...
                <div className={styles.table}>
                  <div className={styles.row + " " + styles.header}>
                    ...
                    <div className={styles.cell}>
                      ...
                      использования Сайта, оказания услуг, обработки запросов и
                    ...
                    <div className={styles.cell}>
                      <ul>
                        ...
                        <li>
                          ...
                          разрешение, версия и другие атрибуты, характеризуемые
                          пользовательское устройство)
                        </li>
                        <li>
                          Пользовательские клики, просмотры страниц, заполнения
                          полей, показы и просмотры баннеров и видео
                        </li>
                  ...
                  <div className={styles.row}>
                    ...
                    <div className={styles.cell}>
                      <ul>
                        ...
                        <li>
                          Отправка СМС сообщений и телефонных звонков,
            ...
            <section className={styles.section}>
              ...
              <ul>
                ...
                <li>
                  ...
                  Оператора edu@vibro-laser.com с пометкой «Актуализация
                  персональных данных».
                </li>
                <li>
                  ...
                  edu@vibro-laser.com с пометкой «Отзыв согласия на обработку
                  персональных данных».
                </li>
                <li>
